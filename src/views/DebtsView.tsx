      ...
      <div className="flex gap-2 mb-4">
        <div className="flex-1 bg-red-50 p-4 rounded-xl border border-red-100">
          ...
          <p className="text-xl font-bold text-red-700 mt-1">
            {currencyPrefix}
            {sumDebts("I_OWE").toLocaleString(undefined, {
        ...
        <div className="flex-1 bg-emerald-50 p-4 rounded-xl border border-emerald-100">
          ...
          <p className="text-xl font-bold text-emerald-700 mt-1">
            {currencyPrefix}
            {sumDebts("OWES_ME").toLocaleString(undefined, {
              maximumFractionDigits: 2,
            })}
          </p>
        </div>
        ...
        {debts.map((debt) => (
          ...
          >
            ...
            <div className="flex justify-between items-center text-xs text-slate-500 mb-2">
              ...
              <span>
                Restante:{" "}
                {(debt.amount - debt.paidAmount).toLocaleString(undefined, {
                  maximumFractionDigits: 2,
                })}
              </span>
            </div>
